...
base='bkodi16'
ADDON=xbmcaddon.Addon(id='plugin.program.bkodi16')
...
EXCLUDES     = ['plugin.program.bkodi16']
HOME         =  xbmc.translatePath('special://home/')

    
def CATEGORIES():
    link = OPEN_URL('https://lituskodi16.000webhostapp.com/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp = xbmcgui.DialogProgress()
    dp.create("Tu Wizard","Wizard is Whizzing down your Wires ",'', 'Put the kettle on')
    ...
    time.sleep(2)
    dp.update(0,"", "Extracting Your KODI setup now, Please Wait")
    print '======================================='
    print addonfolder
    print '======================================='
...
def killxbmc():
    choice = xbmcgui.Dialog().yesno('Force Close XBMC/Kodi', 'We will now attempt to force close Kodi, Would you like to continue?', nolabel='No, Cancel',yeslabel='Yes, Close')
    if choice == 0:
        INDEX()
    elif choice == 1:
        pass
...
def FRESHSTART(params):
    ...
    choice2 = xbmcgui.Dialog().yesno("Are you sure?", 'Are you sure you want to wipe this install?', '', 'All addons EXCLUDING Kodi PR Wizard will be completely wiped!', yeslabel='Yes',nolabel='No')
    if choice2 == 0:
        return
    elif choice2 == 1:
